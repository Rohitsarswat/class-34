...
var emptyStar, oneStar, twoStar, stars
...
function setup() 
{
  ...
  star1 = createSprite(320,50,10,10)
  star1.addImage(starImg)
  star1.scale = 0.02;

  star2 = createSprite(50,370,10,10)
  star2.addImage(starImg)
  star2.scale = 0.02;

  stars = createSprite(50,20,10,10)
...
function blowAir(){
  Body.applyForce(fruit,{x:0, y:0}, {x:0, y:-0.04})
  air.play()
}
